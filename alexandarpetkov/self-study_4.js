...
function howOldAmI(searchAge) {
    ...
    var months = Math.round((nowDate.getMonth()+1) - myMonth);
    var days = Math.round(nowDate.getDate() - myDay);
    ...
    if (days < 0) {
        myAge = 'you are on: ' + years + ' years ' + months + ' months ' + 'and ' + days + ' days';
        days = 30 + days;
        years = years - 1;
        months = 12 + months -1;
        if (months < 0) {
    ...
    // BIRTH-DAY
    if (months == 0 && days == 0) {
        console.log(myAge = 'you are on: ' + years + ' years ' + months + ' months ' + 'and ' + days + ' days' + '   Happy birthday!!!')
    }
